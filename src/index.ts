...
async function main() {
  try {
    ...
    console.error(
      "📚 Available databases: PubMed, UniProtKB, GenBank, Ensembl, KEGG, PDB"
    );
    console.error(
      "🔧 Available tools: 37 (3 PubMed + 3 UniProt + 4 Nucleotide + 3 Enhanced Protein + 4 DNA Analysis + 3 Protein Sequence + 5 Similarity + 4 Multiple Alignment + 4 Structure & RNA + 2 Phylogenetics + 2 Documentation)"
    );
  } catch (error) {
